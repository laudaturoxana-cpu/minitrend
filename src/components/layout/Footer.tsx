...
export const Footer = () => {
  return (
    <footer className="bg-white mt-auto overflow-x-hidden">
      {/* Newsletter Section */}
      <div className="bg-gradient-to-r from-primary via-primary-dark to-primary py-12 md:py-16 lg:py-20 text-white">
      ...
      <div className="container px-5 md:px-6 py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 lg:gap-16">
          {/* Brand Column */}
